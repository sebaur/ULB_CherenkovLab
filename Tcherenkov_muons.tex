...
\textbf{Lundi}
\begin{itemize}
\item Prise de connaissance avec le matériel
\item Vérification du signal analogique des PMs avec l'oscilloscope.
\item Implémentation de la table de vérité pour la logique d'acquisition ou trigger.
\item Mesure de l'efficacité
\end{itemize}
\vspace{\baselineskip}
\textbf{Mardi}
\begin{itemize}
\item Calibration de l'ADC
\item Préparation de l'acquisition de données
\item Début de l'acquisition de données avec LabView
\end{itemize}
\vspace{\baselineskip}
\textbf{Mercredi}
\begin{itemize}
\item Construction de la logique d'acquisition du bruit de fond.
\item Écriture de la table de vérité pour définir un événement du bruit.
\item Début de l'acquisition de données pour le bruit de fond
\end{itemize}
\vspace{\baselineskip}
\textbf{Jeudi et Vendredi}
\begin{itemize}
\item Développement d'un programme de génération MC d'une distribution normale
