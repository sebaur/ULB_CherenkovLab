...
Chaque OM est composé d'un photmultiplicateur (PM) contenu dans une bulle de verre sous vide. Les PMs sont des détecteurs basés sur l'effet photoélectrique. Lorsq'un photon arrive à la photocathode, il arrache un électron par effet photoélectrique ; Le faible courant ainsi produit est ensuite amplifié par une série de dynodes afin d'obtenir un gain important. \\
...
Dans cette section, nous allons passer en revue les différents modules qui seront utile à la 
